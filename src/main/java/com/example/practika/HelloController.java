...
//        SplitPane newPane = new SplitPane();
    ...
    public void switchTheme() {
        if (theme == 0) {
            theme += 1;
            sPane.getStylesheets().remove(  getClass().getResource( "lightTheme.css" ).toExternalForm() );
            sPane.getStylesheets().add( getClass().getResource( "darkTheme.css" ).toExternalForm() );
        } else {
            theme -= 1;
            sPane.getStylesheets().remove( getClass().getResource( "darkTheme.css" ).toExternalForm() );
            sPane.getStylesheets().add( getClass().getResource( "lightTheme.css" ).toExternalForm() ) ;
        }
    }
